...
foreach($users as $user){
	...
	<tr>
        ...
        /*if($user->student_id == '001'){echo "ภาควิชาชีววิทยา";
    		}elseif ($user->student_id == '002') {echo "ภาควิชาเคมี";
    	    	}elseif ($user->student_id == '003') {echo "ภาควิชาฟิกสิกส์และวัสดุศาสตร์";
    	        	}*/

         echo $user->student_dept;
